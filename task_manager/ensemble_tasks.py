...
def ensemble_exec(self, explanation_id, feature_importance, task_type, uri_datasource, uri_model):

    logger.info(f"ENSEMBLE_EXEC: running explanation (id={explanation_id}) (task_id={self.request.id})")
